...
from sort import *
from counter import get_roi_contour, is_in_roi, get_count_change, is_empty_roi
...
while True:
    ...
    if buff < 0:  # This is resetting procedure
        ...
        ped_count_in_roi = buff
    if is_empty_roi(pre_objs, current_objs):  # This is also resetting procedure
        ped_count_in_roi = 0
    cv2.putText(frame, str(ped_count_in_roi), (20, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
